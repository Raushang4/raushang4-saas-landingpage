    ...
    <div className="p-6 rounded-md shadow">
      ...
      <section>
        ...
        <p>
          ...
          Terms and Conditions Generator. Third-party Social
          Media Service means any services or content
          ...
          Service. Website refers to raushang4, accessible from
          http://raushang4.dev/ You means the individual
      ...
      <section>
        ...
        users regarding the use of the Service. Your access
        to and use of the Service is conditioned on Your
        ...
        to be bound by these Terms and Conditions. If You
        disagree with any part of these Terms and Conditions
        then You may not access the Service. You represent
        that you are over the age of 18. The Company does
        not permit those under 18 to use the Service. Your
        access to and use of the Service is also conditioned
        on Your acceptance of and compliance with the
        Privacy Policy of the Company. Our Privacy Policy
        describes Our policies and procedures on the
      ...
      <p>
        ...
        by the Company. The Company has no control over, and
        ...
        web sites or services. We strongly advise You to
        read the terms and conditions and privacy policies
      ...
      <p>
        ...
        breach these Terms and Conditions. Upon termination,
      ...
      <p>
        ...
        the Service or 100 USD if You havent purchased
        ...
        for loss of profits, loss of data or other
        ...
        remedy fails of its essential purpose. Some states
        ...
        each partys liability will be limited to the
      ...
      <p>
        ...
        of the companys provider makes any representation or
        ...
        included thereon; (ii) that the Service will be
        ...
        or (iv) that the Service, its servers, the content,
        or e-mails sent from or on behalf of the Company are
        free of viruses, scripts, trojan horses, worms,
        ...
        statutory rights of a consumer, so some or all of
        the above exclusions and limitations may not apply
        to You. But in such a case the exclusions and
        limitations set forth in this section shall be
      ...
      <p>
        ...
        under these Terms shall not affect a partys ability
      ...
      <p>
        ...
        terms, in whole or in part, please stop using the
