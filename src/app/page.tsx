        ...
        <div className="flex flex-col gap-12 items-center">
          ...
          <div className="flex md:flex-row flex-col gap-12">
            ...
            <Feature
              ...
              description="Works with PagerDuty, Jira, or custom Slack alerts—raushang4 integrates with any system"
            />
            <Feature
